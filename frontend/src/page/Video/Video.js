...
const usernames = userInfoFromStorage ? userInfoFromStorage.firstName : ""
...
class Video extends Component {
  ...
  name = () => {
    if (userInfoFromStorage) {
      return userInfoFromStorage.firstName + " " + userInfoFromStorage.lastName
    }  else {
      return ""
    }
  }
  ...
  handleUsername = (e) => {
    this.setState({
      username: userInfoFromStorage.firstName,
    })
  }
